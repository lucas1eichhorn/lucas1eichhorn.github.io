                ...
                <div className="row">
                    <div className="col-xl-5 col-lg-6 col-md-12 col-sm- col-">
                        <div className="fun-fact-content mb-50 mr-lg-2 mr-xl-0">
                            ...
                            <p>
                            Passionate about building reliable and efficient systems, I create digital solutions that deliver real impact. With 9 years of experience across multiple industries, I&apos;ve contributed to 50+ projects, shaping innovative products and enhancing business operations.
                            </p>
                        </div>
                    </div>
