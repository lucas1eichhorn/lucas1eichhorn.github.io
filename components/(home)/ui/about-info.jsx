...
export default function AboutInfo() {
    return (
        <div className="about-content position-relative mb-50">
            ...
            <p className="mb-2">
                I'm an Argentinian data engineer based in Madrid, where I moved to study a master degree in Big Data Science in 2021.
            </p>
            <p className="mb-2">
                I have experience in full stack development, with +6 years in the software industry working as a Full Stack developer, creating web and mobile applications for different industries. Therefore, I have a deep understanding of transactional applications world, data and software engineering lifecycle with coding best practices in different programming languages,
            </p>
            <p className="mb-2">
                A few years ago, I decided to focus my career on Big Data & AI technologies. I found my experience along with data engineering tools really useful. Using all these acquired skills together helping my teams achieve the organization's goals.
            </p>
